...
\index{linguaggio!alto livello}
\index{linguaggio!basso livello}
...
\index{collaudo!modalità interattiva}
...
\index{errori di sintassi}
\index{errori!sintassi}
\index{messaggi di errore}
...
\index{divisione!floor}
\index{divisione!virgola mobile}
...
\index{funzioni produttive}
\index{funzioni vuote}
...
\begin{exercise}
\index{alfabeto}
\index{macchina da scrivere, tartaruga}
...
\index{serie, condizioni}
\index{condizione!serie}
...
\begin{exercise}
\index{Ultimo teorema di Fermat}
...
Le funzioni possono anche restituire valori booleani (vero o falso), cosa che è spesso utile per includere al loro interno dei test anche complessi.  \index{funzione booleana}
Per esempio:
...
\index{condizioni di guardia}
\index{condizioni!guardia}
...
\index{initializzazione (prima di aggiornare)}
...
\index{riporto, addizione con}
\index{sottrazione!con prestito}
\index{prestito, sottrazione con}
...
\index{sequenza}
\index{carattere}
\index{operatore parentesi quadrata}
\index{operatore!parentesi quadrata}
...
\index{oggetto}
\index{assegnazione di elemento}
...
\index{cicli!con indici}
\index{indici!cicli con}
...
\section{Debug}
\index{debug}
\index{collaudo!difficile}
\index{programma, collaudo}
...
\index{collaudo!e assenza di bug}
...
\index{accesso}
\index{indice}
\index{parentesi quadra, operatore}
\index{operatore!parentesi quadra}
...
\index{aggiornamento, operatore}
\index{operatore!aggiornamento}
...
\index{slicing, operatore}
\index{operatore!slicing}
...
\index{ariabile globale!aggiornamento}
...
\index{sanità, controllo}
\index{coerenza, controllo}
...
\index{scambio, schema}
\index{schema!scambio}
...
\index{gather}
\index{parametro!gather}
\index{argomento!gather}
...
\index{formato, errore}
\index{errore!formato}
...
\url{http://thinkpython.com/code/most_frequent.py}.  \index{lettera,
  frequenza} \index{frequenza!lettera}
...
\vspace{0.2in}
\begin{exercise}
\index{istogramma!random choice}
...
\index{default, valore}
\index{valore!default}
...
\index{esplora, directory}
\index{directory!esplora}
